    ...
    <div class="container position-relative">
        ...
        <div class="py-5 row">
            ...
            <div class="pb-2 align-items-starrt sec-title col">
                ...
                <h2 class="m-0">{{trans('lang.pay_with_mercadopago')}}</h2>
                ...
                <div>
                    ...
                    <div class="siddhi-cart-item mb-3 rounded shadow-sm bg-white overflow-hidden">
                        ...
                        <div class="siddhi-cart-item-profile bg-white p-3">
                                ...
                                <table class="payment-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right payment-buttons">
                                            ...
                                            <form action="<?php echo route('process-mercadopago'); ?>" method="post">
                            ...
                            <button type="submit" class="btn btn-primary">{{trans('lang.pay_$')}}<?php echo $amount; ?></button>
...
<script type="text/javascript">
    ...
    var mercadopago = new MercadoPago('<?php echo $mercadopago_public_key; ?>');

    var elements = mercadopago.elements();
    ...
    function setOutcome(result) {
        ...
        if (result.token) {
            ...
            $.ajax({
                ...
                url: "<?php echo route('process-mercadopago'); ?>",
    ...
    document.querySelector('form').addEventListener('submit', function (e) {
        ...
        mercadopago.createToken(card, extraDetails).then(setOutcome);
