...
<div class="bg-white px-3 clearfix delevery-partner"
    ...
    <?php $digit_decimal = 0;
                ...
                <label class="custom-control-label" for="10"><span
                            class="currency-symbol-left"></span> <?php echo number_format(10, $digit_decimal);?><span
...
<div class="bg-white p-3 clearfix btm-total">
    ...
    <p class="mb-2">
        ...
        <span class="currency-symbol-right"></span> <?php if(@$cart['deliverykm']){ ?> (<?php echo round($cart['deliverykm'], 2); ?>Km) <?php } ?> </span>
