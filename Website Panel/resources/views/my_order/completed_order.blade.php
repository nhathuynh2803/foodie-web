            ...
            <div class="col-md-12 top-nav mb-3">
                <ul class="nav nav-tabsa custom-tabsa border-0 bg-white rounded overflow-hidden shadow-sm p-2 c-t-order"
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link border-0 text-dark py-3 active" href="{{url('my_order')}}?activeTab=completed"> <i
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="p-3 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <h6 class="font-weight-bold mb-1">{{trans('lang.special')}} {{trans('lang.offer')}} {{trans('lang.discount')}} <span id="special_offer_text"></span></h6>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('shown.bs.modal', '#reviewModel', function () {
            ...
            if (pid && cid) {
                ...
                database.collection('vendor_categories').doc(cid).get().then(async function (snapshots) {
                    ...
                    database.collection('foods_review').where('orderid', '==', orderId).where('productId', '==', pid).get().then((docSnapshot) => {
                        ...
                        if (docSnapshot.size) {
                            ...
                            if (itemReviewDoc.photos.length > 0) {
                                $.each(itemReviewDoc.photos, function (key, url) {
                                    $("#uploded_image ul").append('<li><img onerror="this.onerror=null;this.src=\'' + place_image + '\'" src="' + url + '" width="100"><span class="mdi mdi-delete" onerror="this.onerror=null; this.remove();" data-url="' + url + '">X</span></li>');
        ...
        $(document).on('click', '.item_review_btn', function () {
           jQuery("#reviewModel").attr('data-pid', $(this).data('pid')).attr('data-cid', $(this).data('cid')).modal("show");
       });
        ...
        $(".add_review_btn").click(function () {
            ...
            database.collection('foods_review').where('orderid', '==', orderid).where('productId', '==', productId).get().then((docSnapshot) => {
                ...
                if (docSnapshot.size) {
                    ...
                    vendor_data = database.collection('vendors').where('id', "==", VendorId);
    ...
    async function getOrderDetails() {
        ...
        completedorsersref.get().then(async function (completedorderSnapshots) {
            ...
            if (orderDetails.author.id != user_uuid) {
                ...
                var scheduleTime = '';
                if (orderDetails.hasOwnProperty('scheduleTime') && orderDetails.scheduleTime != null && orderDetails.scheduleTime != '') {
                    ...
                    $('.schedule_date').append('<label class="col-12 control-label pl-0"><strong>{{trans("lang.schedule_date_time")}}:</strong><span id=""> ' + scheduleDateTime + '</span></label>')
                ...
                for (let i = 0; i < orderDetails.products.length; i++) {
                    ...
                    order_items += '<tr>';
                    if (orderDetails.products[i]['photo'] != '' && orderDetails.products[i]['photo'] != null) {
                        order_items += '<td class="ord-photo"><img onerror="this.onerror=null;this.src=\'' + place_image + '\'" alt="#" src="' + orderDetails.products[i]['photo'] + '" class="img-fluid order_img rounded"></td>';
                    } else {
            ...
            if (orderDetails.hasOwnProperty('taxSetting')) {
                ...
                if (currencyAtRight) {
                    ...
                    special_dicount_total = parseFloat(special_discount).toFixed(decimal_degits) + "" + currentCurrency;
                } else {
                    ...
                    special_dicount_total = currentCurrency + "" + parseFloat(special_discount).toFixed(decimal_degits);
        ...
        callback: function(base64str) {
            ...
            uploadTask.on('state_changed', function (snapshot) {
                ...
                uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                    ...
                    jQuery("#uploded_image ul").append('<li><img onerror="this.onerror=null;this.src=\'' + place_image + '\'" src="' + downloadURL + '" width="100"><span class="mdi mdi-delete" data-url="' + downloadURL + '">X</span></li>');
                    setTimeout(function () {
