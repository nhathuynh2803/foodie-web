			...
			<div class="col-md-12 top-nav mb-3">
				...
				<ul class="nav nav-tabsa custom-tabsa border-0 bg-white rounded overflow-hidden shadow-sm p-2 c-t-order" id="myTab" role="tablist">
					...
					<li class="nav-item border-top" role="presentation">
						...
						<a class="nav-link border-0 text-dark py-3 active" href="{{url('my_order')}}?activeTab=progress"> <i class="feather-clock mr-2 text-warning mb-0"></i>
						...
						<div class="row">
							...
							<div class="col-lg-12">
									...
									<div class="p-3 border-bottom">
										...
										<img onerror="this.onerror=null;this.src=\'' + place_image + '\'" alt="#" src="img/logo_web.png" class="img-fluid sc-siddhi-logo mr-2"><span class="small text-primary font-weight-bold">{{trans('lang.grocery_courier')}} </span>
	...
	async function getOrderDetails() {
        ...
        if (orderDetails.author.id != user_uuid) {
            ...
            if (currencyAtRight) {
                ...
                order_special_discount = parseFloat(special_discount).toFixed(decimal_degits) + "" + currentCurrency;
            } else {
                ...
                order_special_discount = currentCurrency + "" + parseFloat(special_discount).toFixed(decimal_degits);
            }
